...
/*   Updated: 2024/01/08 19:53:20 by ilasrarf         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::ClapTrap()
{
    std::cout << "ClapTrap--> defult constractor called" << std::endl;
    this->name = "ClapTrap";
    this->Hit_points = 10;
...
{
    std::cout << "ClapTrap--> string constractor called" << std::endl;
    this->name = name;
    this->Hit_points = 10;
    this->Energy_points = 10;
    this->Attack_damage = 0;
...
{
    std::cout << "ClapTrap--> defult copy constractor called" << std::endl;
    this->name = obj.name;
